...
$subject = 'New Project Inquiry from ' . $fullName . ' (Contact Form)';
...
<div class="container">
    <div class="header"><h2 style="margin:0">New Project Inquiry</h2>
        <p style="margin:5px 0 0;font-size:14px">Bhoomi Tech Zone - Contact Form</p></div>
    <div class="content">
        ...
        <div class="footer"><p>Bhoomi Tech Zone Website - Contact Form</p><p>Received: ' . date('F j, Y, g:i a') . '</p></div>
    </div>
</div></body></html>';
...
if (mail($to, $subject, $htmlBody, $headers)) {
    ...
    error_log('[send-contact-email] mail() failed');
